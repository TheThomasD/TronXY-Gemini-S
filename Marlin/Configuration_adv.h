 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 15   // Degrees Celsius 4->15
 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD                 180 // Seconds 60->180
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS    (X1_MIN_POS + HOTEND_TO_HOTEND) // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
  #define X2_MAX_POS    (X_BED_SIZE + X2_TO_BED) // Set this to the distance between toolheads when both heads are homed
  #define X1_MAX_POS    (X2_MAX_POS - HOTEND_TO_HOTEND)  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           30  // Time limit before the nozzle is turned off for safety.
...
#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_USE_PWM                // Enable if your controller supports setting the speed/power
    ...
    #if LASER_SERIAL
    #define SPINDLE_LASER_FREQUENCY     1200
    #else
